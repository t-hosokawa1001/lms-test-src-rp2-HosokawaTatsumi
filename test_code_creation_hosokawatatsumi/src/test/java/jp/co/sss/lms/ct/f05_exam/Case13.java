...
public class Case13 {
	...
	void test06() {
		...
		visibilityTimeout(By.tagName("body"), 60);
		assertEquals("ITリテラシー① | LMS", webDriver.getTitle());
		assertEquals("回答数：0／12", webDriver.findElement(By.xpath("//small[contains(text(), '回答数')]")).getText());
		getEvidence(new Object() {
		});
	...
	void test07() throws InterruptedException {
		...
		visibilityTimeout(By.tagName("body"), 60);
		assertEquals("ITリテラシー① | LMS", webDriver.getTitle());
		assertEquals("あなたのスコア：0.0点   正答数：0／12",
	...
	void test08() {
		...
		visibilityTimeout(By.tagName("body"), 60);
		assertEquals("試験【ITリテラシー①】 | LMS", webDriver.getTitle());
		assertEquals("0.0点", webDriver.findElement(By.xpath("//tr[contains(., '" + testDate + "')]/td[2]")).getText());
		scrollBy("1000");
		getEvidence(new Object() {
		});
	}
